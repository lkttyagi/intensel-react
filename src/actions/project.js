...
export const getLoss =(formdata)=>{
		...
		fetch('https://www.api-intensel.live/api/portfolio/loss&risk/'+id+'/',{headers,method:'POST',body:formdata})
			.then(res=>{
				if(res.status < 500){
...
export const getSummary=(formdata)=>{
		...
		fetch('https://www.api-intensel.live/api/portfolio/summary/'+id+'/',{headers,method:'POST',body:formdata})
			.then(res=>{
				if(res.status < 500){
